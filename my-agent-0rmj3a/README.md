...
- [Add tools to your agent](https://github.com/microsoft-foundry/foundry-samples/tree/ad7fe2846bb0065dadc45f60fb51df1ba655e05d/samples/python/hosted-agents/agent-framework/responses/02-tools/) — sample with local tool functions
- [Connect to MCP servers](https://github.com/microsoft-foundry/foundry-samples/tree/ad7fe2846bb0065dadc45f60fb51df1ba655e05d/samples/python/hosted-agents/agent-framework/responses/03-mcp/) — sample using remote MCP tool providers
- [Use Foundry Toolbox](https://github.com/microsoft-foundry/foundry-samples/tree/ad7fe2846bb0065dadc45f60fb51df1ba655e05d/samples/python/hosted-agents/agent-framework/responses/04-foundry-toolbox/) — sample with Azure Foundry Toolbox integration
